            ...
            <div className="container mx-auto px-4">
                <div className="flex flex-col md:flex-row justify-between items-center">
                    ...
                    <div className="flex space-x-4 mt-4 md:mt-0">
                        <a href="https://x.com/varshithakt" className="hover:text-gray-400" aria-label="Twitter">
                        ...
                        <a href="https://www.varshithakt/" className="hover:text-gray-400" aria-label="LinkedIn">
                ...
                <div className='text-center mb-0'>
                    <p className="text-sm">© 2026 JobHunt. Made with Love ❤️.</p>
                </div>
            </div>
        </footer>
    );
